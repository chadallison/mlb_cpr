...
![](README_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
    ...
    ## [1] "Pythagorean wins is more correlated than run-adjusted margin (0.935 vs. 0.935)"
...
```
    ...
    ## [1] "Chicago White Sox lose by 1 (29)"
