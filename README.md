...
![](README_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
    ...
    ## [1] "Pythagorean wins is more correlated than run-adjusted margin (0.93 vs. 0.93)"
...
```
    ...
    ##    <chr>                <int>  <int>   <dbl>
    ##  1 Los Angeles Dodgers     25      8   0.758
