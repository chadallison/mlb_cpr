...
message("As of x June 2023: Scatterplot of teams' margins of victory and defeat so far in the #MLB this season. @MLB #baseball #analytics #dataviz #ggplot")
```
### Margins of Victory and Defeat
...
team_margins |>
  ...
  geom_col(aes(reorder(team, marg_diff), def_margin, fill = team), show.legend = F) +
